...
if(CMAKE_CXX_COMPILER_ID MATCHES "AppleClang")
  ...
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "6.1"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.3")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++1y")
  endif()
  # It seems Apple started changing version numbers after 3.1, going straight to
  # 4.0 after 3.1.
  ...
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.1")
    message(
      FATAL_ERROR
        "Building with a Apple clang version less than 3.1 is not supported.")
  endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "Clang" AND NOT CMAKE_CXX_SIMULATE_ID
                                                 MATCHES "MSVC") # clang, but
                                                                 # not clang-cl.
  ...
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.0.0"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.5.0")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++14")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.5.0"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.2")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++1y")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.2"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.0")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "3.0")
    message(
      FATAL_ERROR
        "Building with a clang version less than 3.0 is not supported.")
  endif()
elseif(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
  ...
  if((CMAKE_CXX_COMPILER_VERSION VERSION_LESS "7.0.0")
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.2.0")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++14")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "5.2.0"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.8.1")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++1y")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.8.1"
     AND (NOT (CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.7.3")))
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11")
  endif()
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.7.3")
    message(
      FATAL_ERROR
        "Building with a gcc version less than 4.7.3 is not supported.")
  endif()
